<nav x-data="{ open: false }" class="bg-gray-600 border-b border-gray-500">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-jet-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        @else
                            <button class="flex items-center text-sm font-medium text-white hover:text-gray-100 hover:border-gray-100 focus:outline-none focus:text-gray-300 focus:border-gray-100 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 bg-gray-300">
